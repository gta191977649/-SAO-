...
namespace SAP_WPF
{
    public class QianQianOnlineLyrics
    {
        public QianQianOnlineLyrics(bool needproxy)
        {
        ...
        /*
        public static readonly string SearchPath = " http://lrc.feiyes.net/?ar={0}&al=&ti={0}&x=16&y=7";
        public static readonly string DownloadPath = "http://ttlrcct2.qianqian.com/dll/lyricsvr.dll?dl?Id={0}&Code={1}";
        */
